...
public class ListFireStations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_fire_stations);
        ...
        scanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(ListFireStations.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
...
//                    MotherHomeActivity.progressDialog.cancel();
    ...
    void viewMapButton() {
         ...
         * @param MapsActivity
         * */
        Intent intent = new Intent(ListFireStations.this, MapssActivity.class);
...
//    }
        ...
        try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    GeometryController.manipulateData(ListFireStations.stringBuffer);
                }
            }).start();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        protected StringBuffer doInBackground(StringBuffer... stringBuffers) {
            try {
                ...
                StringBuilder stringBuilder = new StringBuilder()
                        .append("https://maps.googleapis.com/maps/api/place/search/json?rankby=distance&keyword=fire+station&location=")
                        .append(latitude)
                        .append(",")
                        .append(longitude)
                ...
                ListFireStations.stringBuffer = buffer;
                return buffer;
    ...
    public void onBackPressed() {           //creating method of onBackPressed
        ...
        Intent intent =  new Intent(ListFireStations.this,MainActivity.class);
        startActivity(intent);
