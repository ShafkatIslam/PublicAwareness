...
import com.example.professt.publicawareness.MainActivity;
...
public class ListPoliceStations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_police_stations);
...
//                    MotherHomeActivity.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
            }
    ...
    void listSelection(int i) {
        ...
        dialog.setTitle(GeometryController.detailArrayList.get(i).getPoliceStationName());
    ...
    void viewMapButton() {
         ...
         * @param MapsActivity
         * */
        Intent intent = new Intent(ListPoliceStations.this, MapsssActivity.class);
...
//    }
    ...
    protected void fillList() {
        ...
        for (int i = 0; i < GeometryController.detailArrayList.size(); i++){
            placeName.add(GeometryController.detailArrayList.get(i).getPoliceStationName());
        }
        ...
        try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    GeometryController.manipulateData(ListPoliceStations.stringBuffer);
                }
            }).start();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        protected StringBuffer doInBackground(StringBuffer... stringBuffers) {
            try {
                ...
                StringBuilder stringBuilder = new StringBuilder()
                        .append("https://maps.googleapis.com/maps/api/place/search/json?rankby=distance&keyword=police+station&location=")
                        .append(latitude)
                        .append(",")
                        .append(longitude)
                ...
                ListPoliceStations.stringBuffer = buffer;
                return buffer;
    ...
    public void onBackPressed() {           //creating method of onBackPressed
        ...
        Intent intent =  new Intent(ListPoliceStations.this,MainActivity.class);
        startActivity(intent);
