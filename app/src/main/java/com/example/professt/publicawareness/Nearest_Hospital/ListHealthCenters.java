package com.example.professt.publicawareness.Nearest_Hospital;
...
import com.example.professt.publicawareness.ViewMapsActivity;
...
//    }
    ...
    public void onBackPressed() {           //creating method of onBackPressed
        ...
        Intent intent =  new Intent(ListHealthCenters.this,MainActivity.class);
        startActivity(intent);
